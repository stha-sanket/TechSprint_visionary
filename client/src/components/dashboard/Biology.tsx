import { MOCK_BIOLOGY_CHAPTERS } from "./biology/mockData";
  ...
  return (
    <div className="space-y-6 p-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="space-y-4">
        {Object.values(MOCK_BIOLOGY_CHAPTERS).map((chapter, i) => (
          <div
            key={chapter._id}
            onClick={() =>
              (window.location.href = `/dashboard/biology/${chapter._id}`)
            }
            className="bg-gray-200 p-4 rounded-3xl shadow-[8px_8px_16px_rgba(163,177,198,0.6),-8px_-8px_16px_rgba(255,255,255,0.5)] flex justify-between items-center group cursor-pointer hover:bg-gray-300 transition-colors"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">1 Lesson</p>
              </div>
            </div>
